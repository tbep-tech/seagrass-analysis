...
# sgmanagement to 4326
sgmanagement <- st_transform(sgmanagement, crs = 4326)
...
[download figure](https://github.com/tbep-tech/State-of-the-Bay/raw/master/figures/seagrasscov.png){target="_blank"}

![](https://github.com/tbep-tech/State-of-the-Bay/raw/master/figures/seagrasscov.png)
...
This tab shows a potential maximum of seagrass based on all SWFWMD coverage maps combined from 1988 to present (continuous and patchy) and a 1950s baseline map.  The total area does not consider changing light conditions or bathymetry and is meant to show only areas where seagrasses have occurred in the past. 
