...
The polygon boundaries are shown below (segments left, management areas right). 

```{r, out.width = '100%'}
m1 <- mapview(tbseg, legend = F, layer.name = 'Bay segments')
m2 <- mapview(sgmanagement, legend = F, layer.name = 'Management areas')
sync(m1, m2)
```
